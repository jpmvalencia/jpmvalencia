# ¡Hola! 👋 Soy Juan Pablo Méndez Valencia
...
### CommunityBooks
- **Descripción**: CommunityBooks es un sistema de gestión de bibliotecas. Permite a las bibliotecas administrar su inventario de libros, buscar usuarios y realizar operaciones CRUD.
...
- **Tecnologías utilizadas**: Java, base de datos MySQL
- **Funcionalidades**:
    - Crear módulos de contenido.
    - Ver perfil propio.
    - Usuarios con permisos limitados para visualizar contenido y editar su perfil.

## Tecnologías Actuales
Actualmente estoy estudiando tecnologías como **Django** y **Spring**, ambas enfocadas al desarrollo web.

¡Hablemos de tecnología y proyectos interesantes! 😊
